...
// )
// var (
//     xici string = "http://www.xicidaili.com/wt/"
//     // xici string = "http://data.api.gkcx.eol.cn/soudaxue/queryProvinceScore.html?messtype=json&size=50&page="
// )

// // func main() {
// //     //getIp("local")
// //     // getIp("http://171.104.132.87:9999")
// //     // getIp("http://113.161.161.188:8080")
// //     getIp("http://61.135.217.7:80")
// // }
...
//                 //存入redis
//                 fmt.Println("IP:%s:%d:%d", ip, port, hBody);
...
//         fmt.Printf("line-99:遇到了错误-并切换ip %s:%s \n", urls, err)
//         // getIp(returnIp())
// 	}
//     return response
// }
